...
const apiRouterOper=require('./b11.routes/apiRouterOperaciones');
const apiRouterAuth=require('./b11.routes/apiRouterAuth')
const RouterAuth=require('./b11.routes/routerAuth')
...
const passport=require('./b14.model/passportAuth')
